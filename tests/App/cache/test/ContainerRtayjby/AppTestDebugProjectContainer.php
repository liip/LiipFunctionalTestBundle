...
class AppTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            'Liip\\FunctionalTestBundle\\Command\\RunParatestCommand' => __DIR__.'/getRunParatestCommandService.php',
            'Liip\\FunctionalTestBundle\\Command\\TestCommand' => __DIR__.'/getTestCommandService.php',
            ...
            'security.authentication.basic_entry_point.secured_area' => __DIR__.'/getSecurity_Authentication_BasicEntryPoint_SecuredAreaService.php',
            ...
            'security.authentication.listener.basic.secured_area' => __DIR__.'/getSecurity_Authentication_Listener_Basic_SecuredAreaService.php',
            ...
            'security.authentication.trust_resolver' => __DIR__.'/getSecurity_Authentication_TrustResolverService.php',
            ...
            'security.user.provider.concrete.chain_provider' => __DIR__.'/getSecurity_User_Provider_Concrete_ChainProviderService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('2u9779IIz4', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        $this->services['router'] = $instance = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, ($this->targetDirs[2].'/../App/routing.yml'), array('cache_dir' => $this->targetDirs[0], 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'AppTestDebugProjectContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'AppTestDebugProjectContainerUrlMatcher', 'strict_requirements' => true), ${($_ = isset($this->services['router.request_context']) ? $this->services['router.request_context'] : $this->getRouter_RequestContextService()) && false ?: '_'});
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dmI3KUSrHe', 0, 'BlSXnQzMBjOBN98kt6JAKr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xWlTtabvwU', 0, 'BlSXnQzMBjOBN98kt6JAKr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MaNTPGxZSU', 0, 'BlSXnQzMBjOBN98kt6JAKr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        $this->services['monolog.handler.nested'] = $instance = new \Monolog\Handler\StreamHandler(($this->targetDirs[2].'/logs/test.log'), 100, true, NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[4].'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath(($this->targetDirs[4].'/src/Resources/views'), 'LiipFunctionalTest');
        $instance->addPath(($this->targetDirs[4].'/src/Resources/views'), '!LiipFunctionalTest');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'router.resource': $value = ($this->targetDirs[2].'/../App/routing.yml'); break;
